...
export default function SoftSkillsTrainerWelcomePage() {
          ...
          <div className="flex items-start space-x-6">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-pink-400 to-purple-400" style={{color: colors.primary.darkpurple}}>
                Freelance Soft Skills & Etiquette Trainer
              </h2>
              
              <div className={`space-y-6 text-black ${typography.body.B2}`}>
                <p className={`text-lg leading-relaxed  ${typography.body.B2}`}>
                Welcome to a world where transformation goes beyond looks.                </p>
                <p className={`text-lg leading-relaxed  ${typography.body.B2}`}>
                We’re inviting passionate trainers who can empower clients with communication, confidence, and presence. From corporate sessions to personal development, your expertise will shape how people carry themselves in every space.                </p>
              </div>
              
              <div className="mt-10">
                <Link href="/forms/SoftSkills&EtiquetteTrainer-registration-form">
                <Button
