...
export default function StylistWelcome() {
          ...
          <div className="flex items-start space-x-6">
            ...
            <div>
              ...
              <div className={`space-y-6 text-black ${typography.body.B2}`}>
                ...
                Thank you for your interest in joining the Styltara creative network!              </p>
                <p className={`text-lg leading-relaxed  ${typography.body.B2}`}>
                We’re looking for skilled stylists who bring fashion, individuality, and vision to every project. Whether it’s wardrobe styling for photoshoots, personal makeovers, or event looks—you’ll collaborate with photographers and creatives to help every client look and feel their best.</p>
              </div>
              
              <div className="mt-10">
                <Link href="/forms/Stylist-registration-form">
                <Button
